...
in
{
  tests = pkgs.testers.runNixOSTest {
    ...
    testScript = ''
      ...
      machine.copy_from_machine("/tmp/gtestslog", "/tmp/gtestslog")
      machine.copy_from_machine("/tmp/testerlog", "/tmp/testerlog")
      machine.copy_from_machine("/tmp/hyprlog", "/tmp/hyprlog")
      machine.copy_from_machine("/tmp/exit_status", "/tmp/exit_status")
      machine.copy_from_machine("/tmp/exit_status_gtests", "/tmp/exit_status_gtests")
