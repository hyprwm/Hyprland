...
void CXDGToplevelResource::setNewParent(SP<CXDGToplevelResource> newParent) {
    ...
    if (m_parent) {
        ...
        if (m_parent->m_window && (m_parent->m_window->m_state & Desktop::View::WINDOW_STATE_PINNED) != Desktop::View::WINDOW_STATE_NONE)
...
CXDGSurfaceResource::CXDGSurfaceResource(SP<CXdgSurface> resource_, SP<CXDGWMBase> owner_, SP<CWLSurfaceResource> surface_) :
    ...
    m_resource->setGetToplevel([this](CXdgSurface* r, uint32_t id) {
        ...
        if (RESOURCE->m_parent && (RESOURCE->m_parent->m_window->m_state & Desktop::View::WINDOW_STATE_PINNED) != Desktop::View::WINDOW_STATE_NONE)
