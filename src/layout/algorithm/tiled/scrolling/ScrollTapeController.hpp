...
namespace Layout::Tiled {
    ...
    enum eInhibitScrollingReason : uint8_t {
        INHIBIT_SCROLL_DISPATCH, // As a result of the user explicitly inhibiting scroll via dispatch
    };
    ...
    struct SScrollingInhibitor {
        ...
        eInhibitScrollingReason reason;
        double                  offsetWhenInhibited; // The position of the m_offset when inhibited is necessary to keep the viewport static
    };
