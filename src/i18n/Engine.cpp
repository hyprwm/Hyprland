...
I18n::CI18nEngine::CI18nEngine() {
    ...
    // id_ID (Indonesia)
    huEngine->registerEntry("id_ID", TXT_KEY_ANR_TITLE, "Aplikasi Tidak Menanggapi");
    huEngine->registerEntry("id_ID", TXT_KEY_ANR_CONTENT, "Aplikasi {title} - {class} tidak menanggapi.\nApa yang ingin Anda lakukan?");
    ...
    huEngine->registerEntry("id_ID", TXT_KEY_PERMISSION_PERSISTENCE_HINT, "Petunjuk: Anda dapat mengatur aturan permanen untuk ini di <i>file config</i> Hyprland.");
    ...
    huEngine->registerEntry("id_ID", TXT_KEY_NOTIF_INVALID_MONITOR_LAYOUT,
                            "Susunan monitor Anda tidak benar. Monitor {name} bertumpuk dengan monitor lain.\nSilakan lihat wiki (halaman <i>Monitors</i>) untuk "
    ...
    huEngine->registerEntry("id_ID", TXT_KEY_NOTIF_MONITOR_AUTO_SCALE, "Skala tidak valid diberikan ke monitor {name}: {scale}, menggunakan skala yang disarankan: {fixed_scale}");
