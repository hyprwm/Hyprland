...
class CHyprOpenGLImpl {
  ...
  private:
    ...
    SP<CGLFramebuffer> blurMainFramebufferWithDamage(float a, CRegion* damage);
    SP<CGLFramebuffer> blurFramebufferWithDamage(float a, CRegion* damage, CGLFramebuffer& source);
