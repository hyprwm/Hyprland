...
static bool test() {
...

    {
        ...
        EXPECT_NOT_CONTAINS(str, "grouped:");
    }
    ...
    {
        auto str = getFromSocket("/activewindow");
        EXPECT_CONTAINS(str, "class: kitty_E");
    }
