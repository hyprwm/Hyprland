...
std::string CCommandFormatter::getWindowData(PHLWINDOW w, eHyprCtlOutputFormat format) {
    ...
    "stableId": "{:x}"
            ...
            ((w->m_state & Desktop::View::WINDOW_STATE_PINNED) != Desktop::View::WINDOW_STATE_NONE ? "true" : "false"),
            (w->fullscreenPolicy().pinFullscreened() ? "true" : "false"), sc<uint8_t>(Fullscreen::controller()->getFullscreenModes(w).internal),
            ...
            (w->fullscreenPolicy().allowedOverFullscreen() ? "true" : "false"), getGroupedData(w, format), getTagsData(w, format), rc<uintptr_t>(w->swallowing().swallowee().get()),
            getFocusHistoryID(w), (g_pInputManager->isWindowInhibiting(w, false) ? "true" : "false"), escapeJSONStrings(METADATA.tag.value_or("")),
            escapeJSONStrings(METADATA.description.value_or("")), escapeJSONStrings(NContentType::toString(w->getContentType())),
            ((w->m_hints & Desktop::View::WINDOW_HINT_TEAR) != Desktop::View::WINDOW_HINT_NONE ? "true" : "false"), w->metadata().stableID());
    } else {
        return std::format(
            "Window {:x} -> {}:\n\tmapped: {}\n\thidden: {}\n\tvisible: {}\n\tacceptsInput: {}\n\tat: {},{}\n\tsize: {},{}\n\tworkspace: {} ({})\n\tfloating: {}\n\tmonitor: "
            "{}\n\tclass: {}\n\ttitle: "
            ...
            sc<int>((w->m_state & Desktop::View::WINDOW_STATE_PINNED) != Desktop::View::WINDOW_STATE_NONE), sc<int>(w->fullscreenPolicy().pinFullscreened()),
            ...
            sc<int>((w->m_hints & Desktop::View::WINDOW_HINT_TEAR) != Desktop::View::WINDOW_HINT_NONE), w->metadata().stableID());
    }
}
...
static std::string getWorkspaceRuleData(const Config::CWorkspaceRule& r, eHyprCtlOutputFormat format) {
    ...
    "workspaceString": "{}"{}{}{}{}{}{}{}{}{}{}{}{}{}
                                         ...
                                         shadow, wobble, defaultName, onCreatedEmpty);
        ...
        std::string result = std::format("Workspace rule {}:\n{}{}{}{}{}{}{}{}{}{}{}{}{}\n", escapeJSONStrings(r.m_workspaceString), enabled, monitor, default_, persistent, gapsIn,
                                         gapsOut, borderSize, border, rounding, decorate, shadow, wobble, defaultName, onCreatedEmpty);
