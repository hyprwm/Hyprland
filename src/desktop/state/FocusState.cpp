...
bool Desktop::isHardInputFocusReason(eFocusReason r) {
    return r == FOCUS_REASON_MOVE_WINDOW_TO_WORKSPACE || r == FOCUS_REASON_NEW_WINDOW || r == FOCUS_REASON_KEYBIND || r == FOCUS_REASON_GHOSTS || r == FOCUS_REASON_CLICK ||
        r == FOCUS_REASON_DESKTOP_STATE_CHANGE || r == FOCUS_REASON_FOCUS_FALLBACK_UNMAP_WINDOW_TILING || r == FOCUS_REASON_SWITCH_TO_WINDOW_HARD;
}
