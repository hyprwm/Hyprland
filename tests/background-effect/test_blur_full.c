/*
 * Test: Full-surface blur via ext-background-effect-v1
 *
 * Creates a centered layer surface and sets the blur region to the entire surface.
 * Verifies basic blur opt-in for layer surfaces without any layerrule.
 */
...
int main(void) {
    ...
    struct zwlr_layer_surface_v1* layer_surface = zwlr_layer_shell_v1_get_layer_surface(layer_shell, surface, NULL, ZWLR_LAYER_SHELL_V1_LAYER_TOP, "test-blur-full");
    ...
    printf("Full-surface blur test running. Press Ctrl+C to exit.\n");
