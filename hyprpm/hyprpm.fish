...
function _hyprpm
    ...
    set literals "--no-shallow" "-n" "::=" "disable" "list" "--help" "update" "add" "--verbose" "-v" "--force" "-s" "remove" "enable" "--notify" "-h" "reload" "-f" "--job"
    ...
    set descriptions[19] "Set the maximum number of parallel build jobs"

    set literal_transitions
    set literal_transitions[1] "set inputs 1 4 5 9 10 7 8 12 6 11 13 14 16 17 18 19; set tos 8 4 5 8 8 5 5 8 8 8 3 4 8 5 8 9"
