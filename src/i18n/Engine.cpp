...
I18n::CI18nEngine::CI18nEngine() {
    ...
    huEngine->registerEntry("lv_LV", TXT_KEY_PERMISSION_REQUEST_UNKNOWN, "Lietotne <b>{app}</b> pieprasa nezināmu atļauju."); // <-- Lietojumprogramma would sound a bit too strong so I opted for using Lietotne instead, both words have the same meaning.
    ...
    huEngine->registerEntry("lv_LV", TXT_KEY_PERMISSION_PERSISTENCE_HINT, "Padoms: Hyprland konfigurācijas failā varat arī iestatīt atļaujas."); // <-- This sounds a bit more easier
    ...
    huEngine->registerEntry(
        "lv_LV", TXT_KEY_NOTIF_EXTERNAL_XDG_DESKTOP,
        "Jūsu XDG_CURRENT_DESKTOP tiek ārēji pārvaldīts, tās vērtība ir {value}.\nTas var neapzināti izraisīt problēmas.");
    huEngine->registerEntry("lv_LV", TXT_KEY_NOTIF_NO_GUIUTILS,
                            "Jums nav instalēts hyprland-guiutils. Šī pakotne ir nepieciešama dažiem dialogiem. Apsveriet tās instalēšanu.");
    ...
    huEngine->registerEntry("lv_LV", TXT_KEY_NOTIF_INVALID_MONITOR_LAYOUT,
    ...
    huEngine->registerEntry("lv_LV", TXT_KEY_NOTIF_CM_RELOAD_FAILED, "CM šeiderus neizdevās pārlādēt, tiek izmantots rgba/rgbx."); // <-- Using ēnotājus instead of šeiderus would sound weird
