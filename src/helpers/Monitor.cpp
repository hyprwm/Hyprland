...
bool CMonitor::attemptDirectScanout() {
    ...
    Debug::log(TRACE, "attemptDirectScanout: surface {:x} passed, will attempt, buffer {} fmt: {} -> {} (mod {})", (uintptr_t)PSURFACE.get(),
               (uintptr_t)PSURFACE->m_current.buffer.m_buffer.get(), m_drmFormat, params.format, params.modifier);
