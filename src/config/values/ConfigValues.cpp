...
#define MS makeConfigValue
    ...
    return std::vector<SP<IValue>>{
        ...
        MS<Int>("decoration:wobble:mesh", "amount of wobble mesh vertices per edge", 8, {.min = 2, .max = 32, .refresh = Supplementary::REFRESH_WINDOW_STATES}),
        MS<Float>("decoration:wobble:stiffness", "spring stiffness for wobble deformation", 120, {.min = 0.0001, .max = 1000}),
        ...
        MS<Float>("decoration:wobble:intensity", "wobble deformation impulse multiplier", 0.15, {.min = 0, .max = 2}),
