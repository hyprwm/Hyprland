...
void IHyprLayout::onEndDragWindow() {
    ...
    if (DRAGGINGWINDOW->m_bDraggingTiled) {
        ...
        CWindow*   pWindow     = g_pCompositor->vectorToWindowUnified(MOUSECOORDS, INPUT_EXTENTS | ALLOW_FLOATING | FLOATING_ONLY, DRAGGINGWINDOW);
...
CWindow* IHyprLayout::getNextWindowCandidate(CWindow* pWindow) {
    ...
    if (pWindow->m_bIsFloating) {
        ...
        if (const auto PWINDOWCANDIDATE = g_pCompositor->vectorToWindowUnified(pWindow->middle(), INPUT_EXTENTS | ALLOW_FLOATING); PWINDOWCANDIDATE && PWINDOWCANDIDATE != pWindow)
    ...
    auto pWindowCandidate = g_pCompositor->vectorToWindowUnified(pWindow->middle(), INPUT_EXTENTS | ALLOW_FLOATING);
