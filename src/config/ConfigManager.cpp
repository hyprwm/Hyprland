...
CConfigManager::CConfigManager() {
    ...
    registerConfigVar("cursor:find_my_cursor", Hyprlang::INT{0});
    registerConfigVar("cursor:find_my_cursor_duration", {1.0f});
    registerConfigVar("cursor:find_my_cursor_scale", {2.0f});
    registerConfigVar("cursor:find_my_cursor_on_shake", Hyprlang::INT{0});
