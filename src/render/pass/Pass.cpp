...
float CRenderPass::oneBlurRadius() {
    ...
    return *PBLURPASSES > 10 ? pow(2, 15) : std::clamp(*PBLURSIZE, static_cast<int64_t>(1), static_cast<int64_t>(40)) * pow(2, *PBLURPASSES); // is this 2^pass? I don't know but it works... I think.
}
