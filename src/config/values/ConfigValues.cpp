...
#define MS makeConfigValue
    ...
    return std::vector<SP<IValue>>{
        ...
        MS<Bool>("binds:movefocus_cycles_fullscreen",
                 "If enabled, when focus is on a fullscreen window, it allows hl.dsp.focus({ direction }) to seek windows. If disabled, it will seek just monitors.", true),
