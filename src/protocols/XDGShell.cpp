...
SP<CXDGPopupResource> CXDGPopupResource::fromResource(wl_resource* res) {
    auto data = static_cast<CXDGPopupResource*>(static_cast<CXdgPopup*>(wl_resource_get_user_data(res))->data());
...
SP<CXDGToplevelResource> CXDGToplevelResource::fromResource(wl_resource* res) {
    auto data = static_cast<CXDGToplevelResource*>(static_cast<CXdgToplevel*>(wl_resource_get_user_data(res))->data());
    return data ? data->m_self.lock() : nullptr;
}
...
SP<CXDGSurfaceResource> CXDGSurfaceResource::fromResource(wl_resource* res) {
    auto data = static_cast<CXDGSurfaceResource*>(static_cast<CXdgSurface*>(wl_resource_get_user_data(res))->data());
    return data ? data->m_self.lock() : nullptr;
}

static void onConfigure(void* data) {
    static_cast<CXDGSurfaceResource*>(data)->configure();
}
...
CXDGPositionerResource::CXDGPositionerResource(SP<CXdgPositioner> resource_, SP<CXDGWMBase> owner_) : m_owner(owner_), m_resource(resource_) {
    ...
    m_resource->setSetConstraintAdjustment([this](CXdgPositioner* r, xdgPositionerConstraintAdjustment a) { m_state.constraintAdjustment = static_cast<uint32_t>(a); });
...
SP<CXDGPositionerResource> CXDGPositionerResource::fromResource(wl_resource* res) {
    auto data = static_cast<CXDGPositionerResource*>(static_cast<CXdgPositioner*>(wl_resource_get_user_data(res))->data());
    return data ? data->m_self.lock() : nullptr;
}
