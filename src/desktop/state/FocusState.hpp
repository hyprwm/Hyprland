...
namespace Desktop {
    enum eFocusReason : uint8_t {
        ...
        FOCUS_REASON_MOVE_WINDOW_TO_WORKSPACE,
        FOCUS_REASON_FOCUS_FALLBACK_MOVE_WINDOW_TO_WORKSPACE,
        FOCUS_REASON_FOCUS_FALLBACK_UNMAP_WINDOW_TILING,
        FOCUS_REASON_FOCUS_FALLBACK_UNMAP_WINDOW_FLOATING,
        FOCUS_REASON_FOCUS_FALLBACK_UNMAP_GROUPED_WINDOW,
