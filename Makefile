...
fractional-scaling-v1-protocol.h:
	$(WAYLAND_SCANNER) server-header \
		$(WAYLAND_PROTOCOLS)/staging/fractional-scale/fractional-scale-v1.xml $@

fractional-scaling-v1-protocol.c:
	$(WAYLAND_SCANNER) private-code \
		$(WAYLAND_PROTOCOLS)/staging/fractional-scale/fractional-scale-v1.xml $@

fractional-scaling-v1-protocol.o: fractional-scaling-v1-protocol.h
